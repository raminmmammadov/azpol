      ...
      if (!this.element.find(".overflow-tab-action").length) {
        var tab_link = $("<a>")
          ...
          .on("click", function (e) {
            e.preventDefault();
            $(this)
              .parents(".nav.nav-tabs")
              .children(".nav-item.overflow-tab")
              .toggle();
          });
...
//Tabs
var tab_a = document.querySelectorAll(".product_tab li a");
var tab_li = document.querySelectorAll(".product_tab li");
tab_a.forEach((item) => {
...
window.addEventListener("scroll", function () {
  if (window.scrollY > 0) {
    document.querySelector(".mt-80").style.marginTop = "90px";
  } else {
    document.querySelector(".mt-80").style.marginTop = "0px";
  }
});
